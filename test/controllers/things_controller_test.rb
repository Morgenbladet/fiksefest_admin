...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { description: @thing.description, email: @thing.email, image: @thing.image, owner: @thing.owner } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { description: @thing.description, email: @thing.email, image: @thing.image, owner: @thing.owner } }
